...
DST_FILE_PATH_IN_PC="$TCAM_BUILD_ROOT/release/fs/devel/usr/bin/thermal-mgr"
TMP_DIR="/tmp/tcam"
TMP_DST_FILE="$TMP_DIR/`basename $DST_FILE_PATH_IN_PC`"
DST_DIR_IN_TARGET="$TARGET_MOUNT_DIR/usr/bin"
...
function main
{
    ...
    rm -f "$DST_DIR_IN_TARGET/`basename $DST_FILE_PATH_IN_PC`"
...
DST_FILE_PATH_IN_PC="$TCAM_BUILD_ROOT/release/fs/devel/usr/bin/tswthm"
TMP_DST_FILE="$TMP_DIR/`basename $DST_FILE_PATH_IN_PC`"
main

DST_FILE_PATH_IN_PC="$TCAM_BUILD_ROOT/release/fs/devel/usr/bin/tswthm_test_client"
TMP_DST_FILE="$TMP_DIR/`basename $DST_FILE_PATH_IN_PC`"
main
