...
APP_BIN_PATH="/usr/bin/coma-core"

INPUT_LOG_FILE="$1"
OUTPUT_MEM_VOC_ALL="${INPUT_LOG_FILE}__RAM__coma_all.txt"

OUTPUT_RSS="${INPUT_LOG_FILE}__RAM__coma_RSS.txt"
OUTPUT_RSS_STATISTICS="${INPUT_LOG_FILE}__RAM__coma_RSS__statistics.txt"
