...
CACHE_FILEPATH="D:\\lsb_bin\\~build_adaptor_wince.cache"
NOT_USE_CACHE=0
CLEAN_BUILD=0
...
BUILD_ADAPTOR_TEMP_BAT_FILEPATH="d:\build_adaptor_temp.bat"
...
build_adaptor()
{
    ...
    cat > "$BUILD_ADAPTOR_TEMP_BAT_FILEPATH" <<EOF
cd /d "$SRC_DIR_WIN"
build $CLEAN_BUILD_OPT
EOF
    unix2dos "$BUILD_ADAPTOR_TEMP_BAT_FILEPATH"

    echo "========================================================================================="
    cat  "$BUILD_ADAPTOR_TEMP_BAT_FILEPATH"
