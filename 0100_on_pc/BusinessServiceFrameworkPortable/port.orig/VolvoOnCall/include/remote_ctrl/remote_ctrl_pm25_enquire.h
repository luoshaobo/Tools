...
//	@file remote_ctrl_pm25_enquire.h
...
///////////////////////////////////////////////////////////////////
#ifndef REMOTE_CTRL_PM25_ENQUIRE_H_
#define REMOTE_CTRL_PM25_ENQUIRE_H_
...
namespace volvo_on_call
{
    ...
    class RemoteCtrlPM25Enquire: public RemoteCtrlCommon
    {
    public:
        /************************************************************/
        // @brief :Constructs
        ...
        // @author     Nie Yujin
        /************************************************************/
        RemoteCtrlPM25Enquire(std::shared_ptr<fsm::Signal> initial_signal);
...
#endif //REMOTE_CTRL_PM25_ENQUIRE_H_
