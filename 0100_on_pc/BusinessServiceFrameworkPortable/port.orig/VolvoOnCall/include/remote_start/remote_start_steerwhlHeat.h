...
//  @file remote_start_steerwhlHeat.h
...
///////////////////////////////////////////////////////////////////
#ifndef TCAM_APPLICATION_REMOTE_STEER_WHEEL_HEAT_H_
#define TCAM_APPLICATION_REMOTE_STEER_WHEEL_HEAT_H_
...
{
class RMT_SteerWhlHeat: public volvo_on_call::RMTStartBasic
{
public:
    RMT_SteerWhlHeat();
    ~RMT_SteerWhlHeat();
...
#endif //TCAM_APPLICATION_REMOTE_STEER_WHEEL_HEAT_H_