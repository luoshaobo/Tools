...
///////////////////////////////////////////////////////////////////
#ifndef TCAM_APPLICATION_REMOTE_SEAT_VENTI_H_
#define TCAM_APPLICATION_REMOTE_SEAT_VENTI_H_
...
class RMT_SeatVenti: public volvo_on_call::RMTStartBasic
{
public:
    RMT_SeatVenti();
    ~RMT_SeatVenti();
...
private:
    ...
    ////////////////////////////////////////////////////////////
    // @brief : set seat ventilation level(0: close, 1: Lv1, 2: Lv2, 3:Lv3)
    //
    ...
    // @author     uia93888, Jan 24, 2019
    ///////////////////////////////////////////////////////////
    bool SetSeat(vc::Req_OperateRMTSeatVenti& req, int32_t seatVenti, int level);
};

}


#endif //TCAM_APPLICATION_REMOTE_SEAT_VENTI_H_