...
static asn_TYPE_member_t asn_MBR_VehicleInfo_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct VehicleInfo, vin),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct VehicleInfo, model),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct VehicleInfo, modelyear),
...
static ber_tlv_tag_t asn_DEF_VehicleInfo_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_VehicleInfo_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* vin */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* model */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* modelyear */
};
static asn_SEQUENCE_specifics_t asn_SPC_VehicleInfo_specs_1 = {
