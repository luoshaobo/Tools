...
static asn_per_constraints_t asn_PER_type_location_constr_2 GCC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_BCC_CL_020_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct BCC_CL_020, location),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static ber_tlv_tag_t asn_DEF_BCC_CL_020_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_BCC_CL_020_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* location */
};
static asn_SEQUENCE_specifics_t asn_SPC_BCC_CL_020_specs_1 = {
	sizeof(struct BCC_CL_020),
	offsetof(struct BCC_CL_020, _asn_ctx),
	asn_MAP_BCC_CL_020_tag2el_1,
	1,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	0,	/* Start extensions */
	2	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_BCC_CL_020 = {
	"BCC-CL-020",
	"BCC-CL-020",
	SEQUENCE_free,
	SEQUENCE_print,
	...
	asn_DEF_BCC_CL_020_tags_1,
	sizeof(asn_DEF_BCC_CL_020_tags_1)
		/sizeof(asn_DEF_BCC_CL_020_tags_1[0]), /* 1 */
	asn_DEF_BCC_CL_020_tags_1,	/* Same as above */
	sizeof(asn_DEF_BCC_CL_020_tags_1)
		/sizeof(asn_DEF_BCC_CL_020_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_BCC_CL_020_1,
	1,	/* Elements count */
	&asn_SPC_BCC_CL_020_specs_1	/* Additional specs */
};
