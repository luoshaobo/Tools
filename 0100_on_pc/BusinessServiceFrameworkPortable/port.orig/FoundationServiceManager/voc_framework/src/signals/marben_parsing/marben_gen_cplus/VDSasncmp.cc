...
VDSasncmp.cc: C++ API compare methods
...
asnBOOL asncpoiss::operator== (const asntype& obj) const
{
  ...
  {
    if(asnGetPresence(optionalField,asn_PointOfInterest__position) != asnFALSE)
    {
...
asnBOOL asncconnectEstablishedLists::operator== (const asntype& obj) const
{
  ...
  {
    if(asnGetPresence(optionalField,asn_ConnectivityInfo__connectTime) != asnFALSE)
    {
  ...
  {
    if(asnGetPresence(optionalField,asn_ConnectivityInfo__connectPosition) != asnFALSE)
    {
  ...
  {
    if(asnGetPresence(optionalField,asn_ConnectivityInfo__connectType) != asnFALSE)
    {
  ...
  {
    if(asnGetPresence(optionalField,asn_ConnectivityInfo__numRetriesConnect) != asnFALSE)
    {
...
asnBOOL ServiceResult::operator== (const asntype& obj) const
{
  ...
  {
    if(asnGetPresence(optionalField,asn_operationType) != asnFALSE)
    {
      if((this->operationType == object->operationType) == asnFALSE)
        return asnFALSE;
    }
    else
    {
...
asnBOOL BatteryStatus::operator== (const asntype& obj) const
{
  ...
  {
    if(asnGetPresence(optionalField,asn_powerLevel) != asnFALSE)
    {
      if((this->powerLevel == object->powerLevel) == asnFALSE)
        return asnFALSE;
    }
    else
    {
  ...
  {
    if(asnGetPresence(optionalField,asn_energyLevel) != asnFALSE)
    {
      if((this->energyLevel == object->energyLevel) == asnFALSE)
        return asnFALSE;
    }
    else
    {
...
asnBOOL ConnectivityStatus::operator== (const asntype& obj) const
{
  ...
  {
    if(asnGetPresence(optionalField,asn_wakeupTimePosition) != asnFALSE)
    {
      if((this->wakeupTimePosition == (TimePosition *) asnBNULL) || (object->wakeupTimePosition == (TimePosition *) asnBNULL))
        return asnFALSE;
      if((*(this->wakeupTimePosition) == *object->wakeupTimePosition) == asnFALSE)
        return asnFALSE;
    }
    else
    {
  ...
  {
    if(asnGetPresence(optionalField,asn_ConnectivityStatus__connectTime) != asnFALSE)
    {
      if((this->connectTime == (TimeStamp *) asnBNULL) || (object->connectTime == (TimeStamp *) asnBNULL))
        return asnFALSE;
      if((*(this->connectTime) == *object->connectTime) == asnFALSE)
  ...
  {
    if(asnGetPresence(optionalField,asn_ConnectivityStatus__connectPosition) != asnFALSE)
    {
      if((this->connectPosition == (Position *) asnBNULL) || (object->connectPosition == (Position *) asnBNULL))
        return asnFALSE;
      if((*(this->connectPosition) == *object->connectPosition) == asnFALSE)
  ...
  {
    if(asnGetPresence(optionalField,asn_ConnectivityStatus__connectType) != asnFALSE)
    {
      if((this->connectType == object->connectType) == asnFALSE)
        return asnFALSE;
    }
  ...
  {
    if(asnGetPresence(optionalField,asn_ConnectivityStatus__numRetriesConnect) != asnFALSE)
    {
      if((this->numRetriesConnect == object->numRetriesConnect) == asnFALSE)
        return asnFALSE;
    }
  ...
  {
    if(asnGetPresence(optionalField,asn_disconnectType) != asnFALSE)
    {
      if((this->disconnectType == object->disconnectType) == asnFALSE)
        return asnFALSE;
    }
    else
    {
  ...
  {
    if(asnGetPresence(optionalField,asn_sleeptimePosition) != asnFALSE)
    {
      if((this->sleeptimePosition == (TimePosition *) asnBNULL) || (object->sleeptimePosition == (TimePosition *) asnBNULL))
        return asnFALSE;
      if((*(this->sleeptimePosition) == *object->sleeptimePosition) == asnFALSE)
        return asnFALSE;
    }
    else
    {
...
asnBOOL ElectricStatus::operator== (const asntype& obj) const
{
  ...
  {
    if(asnGetPresence(optionalField,asn_dcChargeIAct) != asnFALSE)
    {
      if((this->dcChargeIAct == object->dcChargeIAct) == asnFALSE)
        return asnFALSE;
    }
    else
    {
  ...
  {
    if(asnGetPresence(optionalField,asn_dcChargeSts) != asnFALSE)
    {
      if((this->dcChargeSts == object->dcChargeSts) == asnFALSE)
        return asnFALSE;
    }
    else
    {
  ...
  {
    if(asnGetPresence(optionalField,asn_wptChargeIAct) != asnFALSE)
    {
      if((this->wptChargeIAct == object->wptChargeIAct) == asnFALSE)
        return asnFALSE;
    }
    else
    {
  ...
  {
    if(asnGetPresence(optionalField,asn_wptChargeUAct) != asnFALSE)
    {
      if((this->wptChargeUAct == object->wptChargeUAct) == asnFALSE)
        return asnFALSE;
    }
    else
    {
  ...
  {
    if(asnGetPresence(optionalField,asn_wptChargeSts) != asnFALSE)
    {
      if((this->wptChargeSts == object->wptChargeSts) == asnFALSE)
        return asnFALSE;
    }
    else
    {
...
asnBOOL MaintenanceStatus::operator== (const asntype& obj) const
{
  ...
  {
    if(asnGetPresence(optionalField,asn_tyreTempDriver) != asnFALSE)
    {
      if((this->tyreTempDriver == object->tyreTempDriver) == asnFALSE)
        return asnFALSE;
    }
    else
    {
  ...
  {
    if(asnGetPresence(optionalField,asn_tyreTempPassenger) != asnFALSE)
    {
      if((this->tyreTempPassenger == object->tyreTempPassenger) == asnFALSE)
        return asnFALSE;
    }
    else
    {
  ...
  {
    if(asnGetPresence(optionalField,asn_tyreTempDriverRear) != asnFALSE)
    {
      if((this->tyreTempDriverRear == object->tyreTempDriverRear) == asnFALSE)
        return asnFALSE;
    }
    else
    {
  ...
  {
    if(asnGetPresence(optionalField,asn_tyreTempPassengerRear) != asnFALSE)
    {
      if((this->tyreTempPassengerRear == object->tyreTempPassengerRear) == asnFALSE)
        return asnFALSE;
    }
    else
    {
  ...
  {
    if(asnGetPresence(optionalField,asn_indcrTurnRiFrntWarning) != asnFALSE)
    {
      if((this->indcrTurnRiFrntWarning == object->indcrTurnRiFrntWarning) == asnFALSE)
        return asnFALSE;
    }
    else
    {
...
asnBOOL PollutionStatus::operator== (const asntype& obj) const
{
  ...
  {
    if(asnGetPresence(optionalField,asn_airQualityIndex) != asnFALSE)
    {
      if((this->airQualityIndex == object->airQualityIndex) == asnFALSE)
        return asnFALSE;
    }
    else
    {
  ...
  {
    if(asnGetPresence(optionalField,asn_airParticleConcentration) != asnFALSE)
    {
      if((this->airParticleConcentration == object->airParticleConcentration) == asnFALSE)
        return asnFALSE;
    }
    else
    {
...
asnBOOL RunningStatus::operator== (const asntype& obj) const
{
  ...
  {
    if(asnGetPresence(optionalField,asn_tyreTempWarningDriver) != asnFALSE)
    {
      if((this->tyreTempWarningDriver == object->tyreTempWarningDriver) == asnFALSE)
        return asnFALSE;
    }
    else
    {
  ...
  {
    if(asnGetPresence(optionalField,asn_tyreTempWarningPassenger) != asnFALSE)
    {
      if((this->tyreTempWarningPassenger == object->tyreTempWarningPassenger) == asnFALSE)
        return asnFALSE;
    }
    else
    {
  ...
  {
    if(asnGetPresence(optionalField,asn_tyreTempWarningDriverRear) != asnFALSE)
    {
      if((this->tyreTempWarningDriverRear == object->tyreTempWarningDriverRear) == asnFALSE)
        return asnFALSE;
    }
    else
    {
  ...
  {
    if(asnGetPresence(optionalField,asn_tyreTempWarningPassengerRear) != asnFALSE)
    {
      if((this->tyreTempWarningPassengerRear == object->tyreTempWarningPassengerRear) == asnFALSE)
        return asnFALSE;
    }
    else
    {
  ...
  {
    if(asnGetPresence(optionalField,asn_seatBeltStatusMidRear) != asnFALSE)
    {
      if(this->seatBeltStatusMidRear == asnFALSE)
      {
        if(object->seatBeltStatusMidRear != asnFALSE) return asnFALSE;
      }
      else
      {
        if(object->seatBeltStatusMidRear == asnFALSE) return asnFALSE;
  ...
  {
    if(asnGetPresence(optionalField,asn_seatBeltStatusThMidRear) != asnFALSE)
    {
      if(this->seatBeltStatusThMidRear == asnFALSE)
      {
        if(object->seatBeltStatusThMidRear != asnFALSE) return asnFALSE;
      }
      else
      {
        if(object->seatBeltStatusThMidRear == asnFALSE) return asnFALSE;
...
asnBOOL TEMStatus::operator== (const asntype& obj) const
{
  ...
  {
    if(asnGetPresence(optionalField,asn_state) != asnFALSE)
    {
      if((this->state == object->state) == asnFALSE)
        return asnFALSE;
    }
    else
    {
 ...
 *    Operator ==
 */
asnBOOL TimePosition::operator== (const asntype& obj) const
{
  const TimePosition* object = asnDCast(const TimePosition*,&obj);
  if(object == (TimePosition*)0) return asnFALSE;
  if(asnGetPresence(object->optionalField,asn_TimePosition__time) != asnFALSE)
  {
    if(asnGetPresence(optionalField,asn_TimePosition__time) != asnFALSE)
    {
      if((this->time == (TimeStamp *) asnBNULL) || (object->time == (TimeStamp *) asnBNULL))
        return asnFALSE;
      if((*(this->time) == *object->time) == asnFALSE)
  ...
  {
    if(asnGetPresence(optionalField,asn_TimePosition__position) != asnFALSE)
    {
      if((this->position == (Position *) asnBNULL) || (object->position == (Position *) asnBNULL))
        return asnFALSE;
      if((*(this->position) == *object->position) == asnFALSE)
