...
void ConnectivityStatus::__copy (const asntype& obj)
{
  ...
  optionalField[0] = object->optionalField[0];
 {
    ...
    {
      if(object->wakeupTime != (TimeStamp *)asnBNULL)
      {
        wakeupTime = (TimeStamp*)object->wakeupTime->__create();
        wakeupTime->__copy(*object->wakeupTime);
      }
      else
      {
        wakeupTime = (TimeStamp *) 0;
      }
    }
    else
    {
      this->wakeupTime = (TimeStamp*) asnBNULL;
    }
 }
 {
    if(asnGetPresence(object->optionalField,asn_wPosition) != asnFALSE)
    {
      if(object->wPosition != (Position *)asnBNULL)
      {
        wPosition = (Position*)object->wPosition->__create();
        wPosition->__copy(*object->wPosition);
      }
      else
      {
        wPosition = (Position *) 0;
      }
    }
    else
    {
      this->wPosition = (Position*) asnBNULL;
    }
 }
 {
 ...
 }
 {
    ...
    {
      if(object->sleeptime != (TimeStamp *)asnBNULL)
      {
        sleeptime = (TimeStamp*)object->sleeptime->__create();
        sleeptime->__copy(*object->sleeptime);
      }
      else
      {
        sleeptime = (TimeStamp *) 0;
      }
    }
    else
    {
      this->sleeptime = (TimeStamp*) asnBNULL;
    }
 }
 {
    if(asnGetPresence(object->optionalField,asn_sPosition) != asnFALSE)
    {
      if(object->sPosition != (Position *)asnBNULL)
      {
        sPosition = (Position*)object->sPosition->__create();
        sPosition->__copy(*object->sPosition);
      }
      else
      {
    ...
    {
      this->sPosition = (Position*) asnBNULL;
    }
 }
}
...
void RunningStatus::__copy (const asntype& obj)
{
 ...
 }
 {
    ...
    {
      seatBeltStatusDriverMid = object->seatBeltStatusDriverMid;
    }
 }
 {
 ...
 }
 {
    ...
    {
      seatBeltStatusThDriverMid = object->seatBeltStatusThDriverMid;
    }
 }
 {
