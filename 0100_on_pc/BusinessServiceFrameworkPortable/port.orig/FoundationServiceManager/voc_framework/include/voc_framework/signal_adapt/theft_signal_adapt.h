...
#ifndef THEFT_SIGNAL_ADAPT_H
#define THEFT_SIGNAL_ADAPT_H
...
class TheftSignalAdapt: public SignalAdaptBase
{
...
public:
    ...
    // @author     TanChang, 27-Feb-2019
    ////////////////////////////////////////////////////////////
    TheftSignalAdapt(asn_wrapper::VDServiceRequest* vdsObj) : SignalAdaptBase(vdsObj){};
    ...
    // @author     TanChang, 27-Feb-2019
    ////////////////////////////////////////////////////////////
    bool SetResultPayload(const TheftServiceResult_t &response);
