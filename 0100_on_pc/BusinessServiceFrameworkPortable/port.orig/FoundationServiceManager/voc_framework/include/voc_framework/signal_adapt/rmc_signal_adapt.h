...
namespace fsm
{
class RmcSignalAdapt: public SignalAdaptBase
{
...
public:
    ...
    // @author     nieyujin, 26-Feb-2019
    ////////////////////////////////////////////////////////////
    RmcSignalAdapt(asn_wrapper::VDServiceRequest* vdsObj) : SignalAdaptBase(vdsObj){};
    RmcSignalAdapt(void * vdsObj) : SignalAdaptBase(vdsObj){};
