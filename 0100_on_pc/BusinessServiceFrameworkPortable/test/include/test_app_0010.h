#ifndef TEST_APP_0010_H
#define TEST_APP_0010_H
...
namespace test_app_0010 {
    ...
    extern IServiceStateMachine *g_pServiceStateMachine;
    ...
    public:
            ...
            , m_rContex(rContex)
        {
            ...
            g_pServiceStateMachine = &rServiceStateMachine;
        }

        virtual ~ServiceEntity_0001()
        {
            BSFWK_LOG_SERVICE_GEN_PRINTF("\n");
            g_pServiceStateMachine = NULL;
        }
        ...
        virtual void OnBSEvent(const std::shared_ptr<BSEvent> event)
        {
            ...
            if (event->GetEventIndex() == EVENT_CUSTOMIZED_EVENT1) {
                BSFWK_LOG_SERVICE_GEN_PRINTF("--- EVENT_CUSTOMIZED_EVENT1 ---\n");
            }
        }
