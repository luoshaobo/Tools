#ifndef TEST_APP_0002_H
#define TEST_APP_0002_H
...
namespace test_app_0002 {
    ...
    public:
        ...
        {
            return std::make_shared<ServiceEntity_0001>(rServiceStateMachine, m_context, std::string("EntityFactory_0001_01"), 1);
        }
    ...
    public:
        ...
        virtual std::shared_ptr<IServiceEntity> CreateServiceEntity(IServiceStateMachine &rServiceStateMachine)
        {
            return std::make_shared<ServiceEntity_0001>(rServiceStateMachine, m_context, std::string("EntityFactory_0001_02"), 2);
        }
