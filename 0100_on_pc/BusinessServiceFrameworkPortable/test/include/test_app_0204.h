#ifndef TEST_APP_0204_H
#define TEST_APP_0204_H

#include "test_app_global.h"

namespace test_app_0204 {
    ...
    public:
            ...
            , m_retryConfig()
        {
            ...
            m_retryConfig.GetTimeoutRetryInfo().SetTimeout(5000);
            ...
            m_retryConfig.SetDuration(10000);
            //m_retryConfig.SetDuration(12000);
        }
