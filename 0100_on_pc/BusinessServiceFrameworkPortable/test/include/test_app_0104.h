#ifndef TEST_APP_0104_H
#define TEST_APP_0104_H

#include "test_app_global.h"

namespace test_app_0104 {
    ...
    public:
            ...
            , m_retryConfig()
        {
            ...
            m_retryConfig.GetTimeoutRetryInfo().SetTimeout(2000);
            ...
            m_retryConfig.SetDuration(6000);
        }
