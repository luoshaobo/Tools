...
namespace test_app_0003 {
    ...
    static void post_service_trigger_signal_0001_01(BusinessServer *&pBusinessServer)
    {
        ...
        std::shared_ptr<fsm::Signal> signal = std::dynamic_pointer_cast<fsm::Signal>(std::make_shared<ServiceTriggerSignal>(transactionId));
    ...
    int test_main(int argc, char *argv[])
    {
        ...
        BusinessService businessService_0001_02(&businessServer02, &factory_0001_02);
        businessServer02.AddService(&businessService_0001_02);
        ...
        really_async(std::bind(&post_service_trigger_signal_0001_02, pBusinessServer2));
