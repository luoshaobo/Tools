...
static asn_TYPE_member_t asn_MBR_Timestamp_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Timestamp, tvSec),
	...
	{ ATF_POINTER, 1, offsetof(struct Timestamp, tvNsec),
...
static asn_TYPE_tag2member_t asn_MAP_Timestamp_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* tvSec */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* tvNsec */
};
