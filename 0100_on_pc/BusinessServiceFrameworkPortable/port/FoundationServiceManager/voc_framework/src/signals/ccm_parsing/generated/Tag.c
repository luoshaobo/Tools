...
int
Tag_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
Tag_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
Tag_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	Tag_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
Tag_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
Tag_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
Tag_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
Tag_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
Tag_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
asn_dec_rval_t
Tag_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
Tag_encode_uper(asn_TYPE_descriptor_t *td,
...
static ber_tlv_tag_t asn_DEF_Tag_tags_1[] = {
