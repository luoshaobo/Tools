...
VDSasntype.h: C++ API declarations
...
/**
 * The value of the enumerated element ServiceWarningTriggerReason__unknown.
 */
enum{ServiceWarningTriggerReason__unknown = 7};
...
/**
 * The value of the enumerated element deactivated.
 */
enum{deactivated = 0};
/**
 * The value of the enumerated element activatedAndUnprovioned.
 */
enum{activatedAndUnprovioned = 1};
/**
 * The value of the enumerated element activatedAndProvisioned.
 */
enum{activatedAndProvisioned = 2};
...
class asncpoiss : public asnListElement
{
   public :
       ...
       * <BR>Optional field: use {@link #asn_PointOfInterest__position} to set the presence in the optional field.
       */
      Position * position;
      /**
       * <br>An UTF8String value.
...
class asncconnectEstablishedLists : public asnListElement
{
   public :
       ...
       * <br>A SEQUENCE value.
       * See {@link TimeStamp} for more informations.
       * <BR>Optional field: use {@link #asn_ConnectivityInfo__connectTime} to set the presence in the optional field.
       */
      TimeStamp * connectTime;
      /**
       * <br>A SEQUENCE value.
       * See {@link Position} for more informations.
       * <BR>Optional field: use {@link #asn_ConnectivityInfo__connectPosition} to set the presence in the optional field.
       */
      Position * connectPosition;
      /**
       * <br>A PrintableString value.
       * <BR>Optional field: use {@link #asn_ConnectivityInfo__connectType} to set the presence in the optional field.
       */
      asnOctetString connectType;
      /**
       * <br>An INTEGER value.
       * <BR>Optional field: use {@link #asn_ConnectivityInfo__numRetriesConnect} to set the presence in the optional field.
       */
...
public:
   ...
   public: // but only for runtime internal use
       ...
       * RUNTIME PRIVATE METHOD. ACCESS TO THIS METHOD IS FORBIDDEN TO THE USER.
       */
      asnPOCTypeAssignment getTypeAssEntry() {return &(asnZOCTypeAssignment[108]);}
      /**
       * RUNTIME PRIVATE METHOD. ACCESS TO THIS METHOD IS FORBIDDEN TO THE USER.
       */
      static asntype * __create();
 ...
 * <BR> format: <vehicle-status> <operator> <target>
 */
...
/**
 * The flag to mark the presence of the element PointOfInterest__position in the optional field.
 */
enum{asn_PointOfInterest__position = 0};
/**
...
enum{asn_error = 0};
/**
 * The flag to mark the presence of the element operationType in the optional field.
 */
enum{asn_operationType = 1};
/**
...
class ServiceResult : public asntype
{
   public:
      ...
      /**
       * <br>A PrintableString value.
       * <BR>Optional field: use {@link #asn_operationType} to set the presence in the optional field.
       */
      asnOctetString operationType;
...
/**
 * The flag to mark the presence of the element powerLevel in the optional field.
 */
enum{asn_powerLevel = 3};
/**
 * The flag to mark the presence of the element energyLevel in the optional field.
 */
enum{asn_energyLevel = 4};
/**
...
class BatteryStatus : public asntype
{
   public:
       ...
       *  not
       * <br>An INTEGER value.
       * <BR>Optional field: use {@link #asn_powerLevel} to set the presence in the optional field.
       */
      asnMAXSINT powerLevel;
      /**
       * <BR> This parameter is only valid when Usage Mode = Driving
       * <br>An INTEGER value.
       * <BR>Optional field: use {@link #asn_energyLevel} to set the presence in the optional field.
       */
      asnMAXSINT energyLevel;
      /**
       * <BR> This parameter is only valid when Usage Mode != Driving     
       * <br>An INTEGER value.
...
/**
 * The flag to mark the presence of the element ConnectivityInfo__connectTime in the optional field.
 */
enum{asn_ConnectivityInfo__connectTime = 0};
/**
 * The flag to mark the presence of the element ConnectivityInfo__connectPosition in the optional field.
 */
enum{asn_ConnectivityInfo__connectPosition = 1};
/**
 * The flag to mark the presence of the element ConnectivityInfo__connectType in the optional field.
 */
enum{asn_ConnectivityInfo__connectType = 2};
/**
 * The flag to mark the presence of the element ConnectivityInfo__numRetriesConnect in the optional field.
 */
enum{asn_ConnectivityInfo__numRetriesConnect = 3};
/**
...
/**
 * The flag to mark the presence of the element wakeupTimePosition in the optional field.
 */
enum{asn_wakeupTimePosition = 0};
/**
 * The flag to mark the presence of the element connectEstablishedList in the optional field.
 */
enum{asn_connectEstablishedList = 1};
/**
 * The flag to mark the presence of the element ConnectivityStatus__connectTime in the optional field.
 */
enum{asn_ConnectivityStatus__connectTime = 2};
/**
 * The flag to mark the presence of the element ConnectivityStatus__connectPosition in the optional field.
 */
enum{asn_ConnectivityStatus__connectPosition = 3};
/**
 * The flag to mark the presence of the element ConnectivityStatus__connectType in the optional field.
 */
enum{asn_ConnectivityStatus__connectType = 4};
/**
 * The flag to mark the presence of the element ConnectivityStatus__numRetriesConnect in the optional field.
 */
enum{asn_ConnectivityStatus__numRetriesConnect = 5};
/**
 * The flag to mark the presence of the element disconnectType in the optional field.
 */
enum{asn_disconnectType = 6};
/**
 * The flag to mark the presence of the element lostConnectionsList in the optional field.
 */
enum{asn_lostConnectionsList = 7};
/**
 * The flag to mark the presence of the element sleeptimePosition in the optional field.
 */
enum{asn_sleeptimePosition = 8};
/**
...
class ConnectivityStatus : public asntype
{
   public:
      ...
      /**
       * <br>A SEQUENCE value.
       * See {@link TimePosition} for more informations.
       * <BR>Optional field: use {@link #asn_wakeupTimePosition} to set the presence in the optional field.
       */
      TimePosition * wakeupTimePosition;
      /**
       * <br>Elements of this SET OF type.
       ...
       * <br>A SEQUENCE value.
       * See {@link TimeStamp} for more informations.
       * <BR>Optional field: use {@link #asn_ConnectivityStatus__connectTime} to set the presence in the optional field.
       */
      TimeStamp * connectTime;
      /**
       * <br>A SEQUENCE value.
       * See {@link Position} for more informations.
       * <BR>Optional field: use {@link #asn_ConnectivityStatus__connectPosition} to set the presence in the optional field.
       */
      Position * connectPosition;
      /**
       * <br>A PrintableString value.
       * <BR>Optional field: use {@link #asn_ConnectivityStatus__connectType} to set the presence in the optional field.
       */
      asnOctetString connectType;
      /**
       * <br>An INTEGER value.
       * <BR>Optional field: use {@link #asn_ConnectivityStatus__numRetriesConnect} to set the presence in the optional field.
       */
      asnMAXSINT numRetriesConnect;
      /**
       * <br>A PrintableString value.
      ...
      /**
       * <br>An INTEGER value.
       * <BR>Optional field: use {@link #asn_disconnectType} to set the presence in the optional field.
       */
      asnMAXSINT disconnectType;
      /**
       * <br>Elements of this SET OF type.
       ...
       * <br>A SEQUENCE value.
       * See {@link TimePosition} for more informations.
       * <BR>Optional field: use {@link #asn_sleeptimePosition} to set the presence in the optional field.
       */
      TimePosition * sleeptimePosition;
 ...
 */
enum{asn_averPowerConsumption = 18};
/**
 * The flag to mark the presence of the element indPowerConsumption in the optional field.
 */
enum{asn_indPowerConsumption = 19};
/**
 * The flag to mark the presence of the element dcDcActvd in the optional field.
 */
enum{asn_dcDcActvd = 20};
/**
 * The flag to mark the presence of the element dcDcConnectStatus in the optional field.
 */
enum{asn_dcDcConnectStatus = 21};
/**
 * The flag to mark the presence of the element dcChargeIAct in the optional field.
 */
enum{asn_dcChargeIAct = 22};
/**
 * The flag to mark the presence of the element dcChargeSts in the optional field.
 */
enum{asn_dcChargeSts = 23};
/**
...
class ElectricStatus : public asntype
{
   public:
      ...
      /**
       * <br>An INTEGER value.
       * <BR>Optional field: use {@link #asn_dcChargeIAct} to set the presence in the optional field.
       */
      asnMAXSINT dcChargeIAct;
      /**
       * <br>An INTEGER value.
       * <BR>Optional field: use {@link #asn_dcChargeSts} to set the presence in the optional field.
       */
      asnMAXSINT dcChargeSts;
      /**
       * <br>An INTEGER value.
      ...
      /**
       * <br>An INTEGER value.
       * <BR>Optional field: use {@link #asn_wptChargeIAct} to set the presence in the optional field.
       */
      asnMAXSINT wptChargeIAct;
      /**
       * <br>An INTEGER value.
       * <BR>Optional field: use {@link #asn_wptChargeUAct} to set the presence in the optional field.
       */
      asnMAXSINT wptChargeUAct;
      /**
       * <br>An INTEGER value.
       * <BR>Optional field: use {@link #asn_wptChargeSts} to set the presence in the optional field.
       */
      asnMAXSINT wptChargeSts;
      /**
       * <br>An INTEGER value.
...
/**
 * The flag to mark the presence of the element tyreTempDriver in the optional field.
 */
enum{asn_tyreTempDriver = 5};
/**
 * The flag to mark the presence of the element tyreTempPassenger in the optional field.
 */
enum{asn_tyreTempPassenger = 6};
/**
 * The flag to mark the presence of the element tyreTempDriverRear in the optional field.
 */
enum{asn_tyreTempDriverRear = 7};
/**
 * The flag to mark the presence of the element tyreTempPassengerRear in the optional field.
 */
enum{asn_tyreTempPassengerRear = 8};
/**
...
class MaintenanceStatus : public asntype
{
   public:
       ...
       * <BR> tyre temperature
       * <br>An INTEGER value.
       * <BR>Optional field: use {@link #asn_tyreTempDriver} to set the presence in the optional field.
       */
      asnMAXSINT tyreTempDriver;
      /**
       * <br>An INTEGER value.
       * <BR>Optional field: use {@link #asn_tyreTempPassenger} to set the presence in the optional field.
       */
      asnMAXSINT tyreTempPassenger;
      /**
       * <br>An INTEGER value.
       * <BR>Optional field: use {@link #asn_tyreTempDriverRear} to set the presence in the optional field.
       */
      asnMAXSINT tyreTempDriverRear;
      /**
       * <br>An INTEGER value.
       * <BR>Optional field: use {@link #asn_tyreTempPassengerRear} to set the presence in the optional field.
       */
      asnMAXSINT tyreTempPassengerRear;
      /**
       ...
       * <BR>{@link #ServiceWarningTriggerReason__unknown}
       ...
       * <BR> 0x0: Invalid, 0x1: valid
       * <br>An INTEGER value.
       * <BR>Optional field: use {@link #asn_indcrTurnRiFrntWarning} to set the presence in the optional field.
       */
      asnMAXSINT indcrTurnRiFrntWarning;
      /**
       * <BR> 0x0: Invalid, 0x1: valid  
       * <br>An INTEGER value.
...
/**
 * The flag to mark the presence of the element airQualityIndex in the optional field.
 */
enum{asn_airQualityIndex = 4};
/**
 * The flag to mark the presence of the element airParticleConcentration in the optional field.
 */
enum{asn_airParticleConcentration = 5};
/**
...
class PollutionStatus : public asntype
{
   public:
      ...
      /**
       * <br>An INTEGER value.
       * <BR>Optional field: use {@link #asn_airQualityIndex} to set the presence in the optional field.
       */
      asnMAXSINT airQualityIndex;
      /**
       * <br>An INTEGER value.
       * <BR>Optional field: use {@link #asn_airParticleConcentration} to set the presence in the optional field.
       */
      asnMAXSINT airParticleConcentration;
...
class RunningStatus : public asntype
{
   public:
      ...
      /**
       * <BR> tyre temperature warning, e.g. normal, warning, etc.  
       * <br>An INTEGER value.
       * <BR>Optional field: use {@link #asn_tyreTempWarningDriver} to set the presence in the optional field.
       */
      asnMAXSINT tyreTempWarningDriver;
      /**
       * <br>An INTEGER value.
       * <BR>Optional field: use {@link #asn_tyreTempWarningPassenger} to set the presence in the optional field.
       */
      asnMAXSINT tyreTempWarningPassenger;
      /**
       * <br>An INTEGER value.
       * <BR>Optional field: use {@link #asn_tyreTempWarningDriverRear} to set the presence in the optional field.
       */
      asnMAXSINT tyreTempWarningDriverRear;
      /**
       * <br>An INTEGER value.
       * <BR>Optional field: use {@link #asn_tyreTempWarningPassengerRear} to set the presence in the optional field.
       */
      asnMAXSINT tyreTempWarningPassengerRear;
      /**
      ...
      /**
       * <br>A BOOLEAN value.
       * <BR>Optional field: use {@link #asn_seatBeltStatusMidRear} to set the presence in the optional field.
       */
      asnBOOL seatBeltStatusMidRear;
      /**
       * <br>A BOOLEAN value.
      ...
      /**
       * <br>A BOOLEAN value.
       * <BR>Optional field: use {@link #asn_seatBeltStatusThMidRear} to set the presence in the optional field.
       */
      asnBOOL seatBeltStatusThMidRear;
      /**
       * <br>A BOOLEAN value.
 ...
 */
enum{asn_networkAccessStatus = 9};
/**
...
class TEMStatus : public asntype
{
   public:
       ...
       * Use the following enumeration values :
       * <BR>{@link #deactivated}
       * <BR>{@link #activatedAndUnprovioned}
       * <BR>{@link #activatedAndProvisioned}
       * <BR>Optional field: use {@link #asn_state} to set the presence in the optional field.
       */
      asnMAXSINT state;
      /**
       * <br>A BOOLEAN value.
...
/**
 * The flag to mark the presence of the element TimePosition__time in the optional field.
 */
enum{asn_TimePosition__time = 0};
/**
 * The flag to mark the presence of the element TimePosition__position in the optional field.
 */
enum{asn_TimePosition__position = 1};
/**
 * Class representing the TimePosition type.
 */
class TimePosition : public asntype
{
   public:
      /**
       * This field is used to indicate the presence or absence of each optional field of this sequence.
       ...
       * <br>A SEQUENCE value.
       * See {@link TimeStamp} for more informations.
       * <BR>Optional field: use {@link #asn_TimePosition__time} to set the presence in the optional field.
       */
      TimeStamp * time;
      /**
       * <br>A SEQUENCE value.
       * See {@link Position} for more informations.
       * <BR>Optional field: use {@link #asn_TimePosition__position} to set the presence in the optional field.
       */
      Position * position;
...
private:
       ...
       * Assignment Operator.
       */
      void operator=(const TimePosition&);

#ifndef asnCodCopytor
      /**
       * Copy constructor.
       */
      TimePosition(const TimePosition& object);
#endif // asnCodCopytor
public:
