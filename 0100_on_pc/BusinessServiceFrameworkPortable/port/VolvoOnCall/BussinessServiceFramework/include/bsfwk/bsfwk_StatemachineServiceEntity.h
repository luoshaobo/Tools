#ifndef BSFWK_STATEMACHINE_SERVICE_ENTITY_H
#define BSFWK_STATEMACHINE_SERVICE_ENTITY_H

#include "bsfwk_Common.h"

namespace bsfwk {

    class StatemachineServiceEntity : public ServiceEntityBase
    {
    protected:
    ...
    protected:
        StatemachineServiceEntity(IServiceStateMachine &rServiceStateMachine, const std::string &serviceName = "UnknownService");
        virtual ~StatemachineServiceEntity();
...
#endif // #ifndef BSFWK_STATEMACHINE_SERVICE_ENTITY_H
