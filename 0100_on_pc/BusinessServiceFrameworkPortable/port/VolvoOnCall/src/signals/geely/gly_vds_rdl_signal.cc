...
namespace volvo_on_call
{
    ...
    GlyVdsRemoteCtrlBasicSignal::GlyVdsRemoteCtrlBasicSignal(fsm::VdServiceTransactionId& transaction_id, std::shared_ptr<RemoteCtrlBasicRequest_t> rcbRequest, const SignalType signal_type)
        : fsm::VdmSignal(transaction_id, signal_type), m_rcbRequest(rcbRequest)
    {
