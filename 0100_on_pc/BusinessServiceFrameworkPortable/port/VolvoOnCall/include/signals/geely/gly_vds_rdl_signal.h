...
namespace volvo_on_call
{
    ...
    public:
        GlyVdsRemoteCtrlBasicSignal(fsm::VdServiceTransactionId& transaction_id, std::shared_ptr<RemoteCtrlBasicRequest_t> rcbRequest, const SignalType signal_type);
