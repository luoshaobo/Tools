...
public:
  ...
  SteadyTimestamp getTimerCreated() const { return m_sTimerCreated; }
  SteadyTimestamp getTimerLatestExpire() const { return m_sTimerLatestExpire; }
  void setTimerLatestExpire(SteadyTimestamp t)  { m_sTimerLatestExpire = t; }
...
protected:
  ...
  SteadyTimestamp m_sTimerCreated;
  SteadyTimestamp m_sTimerLatestExpire;
