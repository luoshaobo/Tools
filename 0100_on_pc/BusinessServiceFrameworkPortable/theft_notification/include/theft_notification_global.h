#ifndef THEFT_NOTIFICATION_GLOBAL_H
#define THEFT_NOTIFICATION_GLOBAL_H
...
#ifdef TCAM_TARGET
    extern std::shared_ptr<fsm::Transaction> CreateTNTransaction();
#endif // #ifdef TCAM_TARGET

} // namespace volvo_on_call {

#endif // #ifndef THEFT_NOTIFICATION_GLOBAL_H
