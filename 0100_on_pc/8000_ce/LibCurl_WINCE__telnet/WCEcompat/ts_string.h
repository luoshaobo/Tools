...
{
	return (unsigned short*) wcscpy((wchar_t*)dest, (wchar_t*)src);
}
...
{
	unicode2ascii((WCHAR*)src, dest, n);
	return dest;
}
...
{
	return (unsigned short*) wcsncpy((wchar_t*)dest, (wchar_t*)src, n);
}
...
{
	return (unsigned short*) wcscat((wchar_t*)dest, (wchar_t*)src);
}
...
{
	return (unsigned short*)wcsdup((wchar_t*)str);
}
