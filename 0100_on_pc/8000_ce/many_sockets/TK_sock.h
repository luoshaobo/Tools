...
public:
    ...
    bool getlocalport(unsigned short &port) const;
    ...
    bool GetLocalSocketAddr(std::string &sAddr, unsigned short &nPort);
    bool GetPeerSocketAddr(std::string &sAddr, unsigned short &nPort);
