...
public:
    ...
    SMF_ErrorCode PostEvent(EventId nEventId, void *pData) { return PostEvent(QUEUE_ID_USER_BASE, 0, 0, nEventId, pData); }
    SMF_ErrorCode SendEvent(QueueId nQueueId, EngineId nEngineId, SenderId nSenderId, EventId nEventId, void *pData);
    SMF_ErrorCode SendEvent(EventId nEventId, void *pData) { return SendEvent(QUEUE_ID_USER_BASE, 0, 0, nEventId, pData); }
