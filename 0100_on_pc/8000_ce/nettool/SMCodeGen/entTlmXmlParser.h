...
public:
    ...
    E_ERR getXmlValuesByXPath(const T_STRING& xpath, T_STRINGS& retTexts);
...
private:
    ...
    E_ERR getXmlValuesByXPath_GetAllNodes(IXMLDOMNodeList* pNodeList, T_STRINGS &retTexts);
    E_ERR getXmlValuesByXPath_GetAllNodes_GetXml(IXMLDOMNode* pNode, BSTR *pbsNodeText);
