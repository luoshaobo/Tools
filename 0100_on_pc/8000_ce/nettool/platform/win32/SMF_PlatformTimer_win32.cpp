...
std::string SMF_PlatformTimerImpl::GetWindowClassName() const 
{
    ...
    sResult = TK_Tools::FormatStr("SMF_PlatformTimerImpl_WindowClassName_%08X_%s", m_nSerialNo, m_sName.c_str());
...
std::string SMF_PlatformTimerImpl::GetWindowName() const
{
    ...
    sResult = TK_Tools::FormatStr("SMF_PlatformTimerImpl_WindowName_%08X_%s", m_nSerialNo, m_sName.c_str());
