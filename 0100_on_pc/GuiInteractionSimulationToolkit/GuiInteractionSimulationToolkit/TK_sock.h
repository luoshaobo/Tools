...
public:
    ...
    bool bind__unix(const char *addr_path);
    ...
    bool connect__unix(const char *addr_path);
    ...
    bool sendto__unix(const void* buf, size_t& size, const char *addr_path);
    bool sendto__unix(const void* buf, size_t& size, void *receiver_addr, socklen_t *receiver_addr_len);
    bool recvfrom__unix(void* buf, size_t& size, void *sender_addr = NULL, socklen_t *sender_addr_len = NULL);
    bool sendmsg_fd__unix(int fd_to_send, const char *addr_path);
    bool sendmsg_fd__unix(int fd_to_send, void *receiver_addr, socklen_t *receiver_addr_len);
    bool recvmsg_fd__unix(int &fd_received, void *sender_addr = NULL, socklen_t *sender_addr_len = NULL);
