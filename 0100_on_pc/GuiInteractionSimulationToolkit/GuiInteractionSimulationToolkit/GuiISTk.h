...
public:
    ...
    virtual bool imgWaitHidden(const std::vector<Image> &images, unsigned int timeout = INFINITE_TIME) = 0;
    virtual bool imgWaitHidden(const std::vector<Image> &images, const Rect &searchRect, unsigned int timeout = INFINITE_TIME) = 0;
    virtual bool imgWaitHidden(const std::vector<Image> &images, const Point &searchBeginningPoint, unsigned int timeout = INFINITE_TIME) = 0;
