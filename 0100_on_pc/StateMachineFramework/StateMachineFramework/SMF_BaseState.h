...
public:
    ...
    SMF_ErrorCode ProcessEvent(SMF_EventId nEventId, ThreadEventArgs *pThreadEventArgs, SMF_SenderId nSenderId, SMF_BaseState **pDestState);
    SMF_ErrorCode ProcessEvent(SMF_EventId nEventId, ThreadEventArgs *pThreadEventArgs, SMF_SenderId nSenderId, SMF_BaseState **pDestState, SMF_BaseState &oRealSrcState, bool bChangeDestState);

    SMF_BaseState *GetNextState(SMF_EventId nEventId);
    SMF_BaseState *GetDefChildState();
    SMF_BaseState *GetFirstChildState();
    ...
    // helper
    //
    SMF_StateRelationship RelationshipTo(const SMF_BaseState *pDstState) const;
    bool IsAncestorTo(const SMF_BaseState *pState2) const;
    bool IsOffspringTo(const SMF_BaseState *pState2) const;
    bool IsInState(const SMF_BaseState *pState2) const;
