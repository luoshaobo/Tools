...
public:
    ...
    SMF_ErrorCode PostEvent(QueueId nQueueId, EngineId nEngineId, SenderId nSenderId, EventId nEventId, ThreadEventArgs *pThreadEventArgs = NULL, ThreadEventArgs2 threadEventArgs2 = 0);
    SMF_ErrorCode PostEvent(EventId nEventId, ThreadEventArgs *pThreadEventArgs = NULL, ThreadEventArgs2 threadEventArgs2 = 0) { return PostEvent(QUEUE_ID_USER_BASE, 0, 0, nEventId, pThreadEventArgs, threadEventArgs2); }
    SMF_ErrorCode SendEvent(QueueId nQueueId, EngineId nEngineId, SenderId nSenderId, EventId nEventId, ThreadEventArgs *pThreadEventArgs = NULL, ThreadEventArgs2 threadEventArgs2 = 0);
    SMF_ErrorCode SendEvent(EventId nEventId, ThreadEventArgs *pThreadEventArgs = NULL, ThreadEventArgs2 threadEventArgs2 = 0) { return SendEvent(QUEUE_ID_USER_BASE, 0, 0, nEventId, pThreadEventArgs, threadEventArgs2); }
...
private:
    ...
    SMF_ErrorCode PostEvent_Local(QueueId nQueueId, EngineId nEngineId, SenderId nSenderId, EventId nEventId, ThreadEventArgs *pThreadEventArgs, ThreadEventArgs2 threadEventArgs2);
    SMF_ErrorCode SendEvent_Local(QueueId nQueueId, EngineId nEngineId, SenderId nSenderId, EventId nEventId, ThreadEventArgs *pThreadEventArgs, ThreadEventArgs2 threadEventArgs2);
    SMF_ErrorCode SendEvent_Local_InSameThread(QueueId nQueueId, EngineId nEngineId, SenderId nSenderId, EventId nEventId, ThreadEventArgs *pThreadEventArgs, ThreadEventArgs2 threadEventArgs2);
    SMF_ErrorCode SendEvent_Local_InOtherThread(QueueId nQueueId, EngineId nEngineId, SenderId nSenderId, EventId nEventId, ThreadEventArgs *pThreadEventArgs, ThreadEventArgs2 threadEventArgs2);
...
public:
    SMF_RemoteThreadAgent(const std::string &sRemoteThreadName)
        : SMF_BaseThread(sRemoteThreadName) {}
};
