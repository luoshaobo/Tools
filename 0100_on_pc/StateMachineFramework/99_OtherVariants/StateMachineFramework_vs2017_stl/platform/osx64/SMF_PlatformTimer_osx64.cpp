...
std::string SMF_PlatformTimerImpl::GetTimerName() const
{
    ...
    sResult = TK_Tools::FormatStr("%s_SMF_PlatformTimerImpl_Timer_%s", SMF_GetDomainStr(m_bSharedInProcesses).c_str(), m_sName.c_str());
...
std::string SMF_PlatformTimerImpl::GetTimerThreadName() const
{
    ...
    sResult = TK_Tools::FormatStr("%s_SMF_PlatformTimerImpl_TimerThread_%s", SMF_GetDomainStr(m_bSharedInProcesses).c_str(), m_sName.c_str());
...
std::string SMF_PlatformTimerImpl::GetLockName() const
{
    ...
    sResult = TK_Tools::FormatStr("%s_SMF_PlatformTimerImpl_Lock_%s", SMF_GetDomainStr(m_bSharedInProcesses).c_str(), m_sName.c_str());
