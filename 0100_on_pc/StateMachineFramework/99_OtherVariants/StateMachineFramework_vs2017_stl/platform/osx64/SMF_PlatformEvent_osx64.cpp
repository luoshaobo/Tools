...
std::string SMF_PlatformEventImpl::GetSemName() const
{
    ...
    sFilePath = TK_Tools::FormatStr("%s/%s_SMF_PlatformEventImpl_sem_%s", SMF_TEMP_DIR_ROOT, SMF_GetDomainStr(m_bSharedInProcesses).c_str(), m_sName.c_str());
