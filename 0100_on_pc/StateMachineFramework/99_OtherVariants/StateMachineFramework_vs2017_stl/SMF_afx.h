...
interface SMF_ThreadEventQueueHandler : public SMF_BaseInterface
{
    ...
    struct Args2DataBase {
        virtual ~Args2DataBase() {}
    };
    typedef std::shared_ptr<Args2DataBase> ThreadEventArgs2;
    struct EventData {
        EventData(EngineId a_nEngineId, SenderId a_nSenderId, EventId a_nEventId, ThreadEventArgs *a_pThreadEventArgs, ThreadEventArgs2 a_threadEventArgs2)
            : nEngineId(a_nEngineId), nSenderId(a_nSenderId), nEventId(a_nEventId), pThreadEventArgs(a_pThreadEventArgs), threadEventArgs2(a_threadEventArgs2) {}

        EventData(const EventData &another)
            : nEngineId(another.nEngineId), nSenderId(another.nSenderId), nEventId(another.nEventId), pThreadEventArgs(another.pThreadEventArgs), threadEventArgs2(another.threadEventArgs2) {}

        EventData &operator =(const EventData &another)
        {
            nEngineId = another.nEngineId;
            nSenderId = another.nSenderId;
            nEventId = another.nEventId;
            pThreadEventArgs = another.pThreadEventArgs;
        ...
        ThreadEventArgs2 threadEventArgs2;
    };
