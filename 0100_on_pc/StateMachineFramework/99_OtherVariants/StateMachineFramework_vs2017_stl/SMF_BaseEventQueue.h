...
public:
    ...
    SMF_ErrorCode PostEvent(EngineId nEngineId, SenderId nSenderId, EventId nEventId, ThreadEventArgs *pThreadEventArgs = NULL);
    SMF_ErrorCode SendEvent(EngineId nEngineId, SenderId nSenderId, EventId nEventId, ThreadEventArgs *pThreadEventArgs = NULL);
