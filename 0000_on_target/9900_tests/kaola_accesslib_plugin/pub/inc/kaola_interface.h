#ifndef KAOLA_INTERFACE_H
#define KAOLA_INTERFACE_H
...
extern "C" {
KaolaApi::Interface *getKaolaInterface(KaolaApi::Callback *pCallback);                             // exported in the plugin dll provided BL team
} // extern "C" {

#endif // #ifndef KAOLA_INTERFACE_H
