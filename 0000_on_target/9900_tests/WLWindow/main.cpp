...
int main ()
{
    WaylandWindow::getInstance()->create();
    return 0;
}
...
//// create egl window
//static void create_window(struct EGLWindow *window, int32_t width, int32_t height)
//{
...
//}
//static void delete_window (struct EGLWindow *window)
//{
...
//// use opengl to draw window.
//static void draw_window (struct EGLWindow *window)
//{
...
//    create_window (&window, WL_WIDTH, WL_WIDTH);
